...
describe('Employee', () => {
    ...
    describe('Creating data', () => {
        ...
        it('should insert new document with "insertOne" method', async () => {
            ...
            await employee.save();
            const savedEmployee = await Employee.findOne({ firstName: 'John', lastName: 'Doe', department: 'Marketing' });
    ...
    describe('Updating data', () => {
        ...
        it('should properly update one document with "updateOne" method', async () => {
            await Employee.updateOne({ firstName: 'John', lastName: 'Doe', department: 'Marketing' }, { $set: { firstName: 'Adam', lastName: 'Doe', department: 'Marketing' } });
            const updatedEmployee = await Employee.findOne({ firstName: 'Adam', lastName: 'Doe', department: 'Marketing' });
    ...
    describe('Removing data', () => {
        ...
        it('should properly remove one document with "deleteOne" method', async () => {
            ...
            const deletedEmployee = await Employee.findOne({ firstName: 'John', lastName: 'Doe', department: 'Marketing' });
